...
@objc open class PinnedMessageCell: UITableViewCell {
    ...
    public override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        self.remove.setHitTestEdgeInsets(UIEdgeInsets(top: -5, left: -20, bottom: 5, right:5))
        self.confirmRemove.setHitTestEdgeInsets(UIEdgeInsets(top: -5, left: -20, bottom: 5, right:5))
