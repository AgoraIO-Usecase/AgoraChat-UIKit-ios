//
//  AgoraChatThreadCreateViewController+ChatToolBarMeida.m
//  chat-uikit
//
...
@implementation EaseThreadCreateViewController (ChatToolBarMeida)
...
- (void)chatToolBarComponentIncidentAction:(AgoraChatToolBarComponentType)componentType
{
    ...
    if (componentType == AgoraChatToolBarCamera) {
...
- (void)_sendVideoAction:(NSURL *)aUrl
{
    ...
    AgoraChatVideoMessageBody *body = [[AgoraChatVideoMessageBody alloc] initWithLocalPath:[aUrl path] displayName:@"video.mp4"];
...
@implementation EaseThreadCreateViewController (ChatToolBarLocation)
...
@implementation EaseThreadCreateViewController (ChatToolBarFileOpen)
