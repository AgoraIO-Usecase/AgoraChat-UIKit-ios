...
+ (void)showMenuItems:(AgoraChatMessage *)message animation:(BOOL)animation didRemoveSelfReaction:(void (^)(NSString * _Nonnull))didRemoveSelfReaction {
    ...
    for (AgoraChatMessageReaction *reaction in message.reactionList) {
...
- (__kindof UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    AgoraChatMessageReaction *reaction = _message.reactionList[indexPath.item];
