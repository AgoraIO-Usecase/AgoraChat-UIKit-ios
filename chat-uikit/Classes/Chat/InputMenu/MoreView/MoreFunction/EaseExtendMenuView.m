...
@property (nonatomic, strong) EaseExtendMenuViewModel *extFuncMode;
@end
...
- (CGFloat)yOffset
{
    return (self.collectionViewSize.height - (self.cellLonger + 6) * self.columCount) / (self.columCount + 1);
}
- (CGSize)collectionViewSize
{
    ...
    return CGSizeMake(self.rowCount * 58 , self.columCount * (self.cellLonger + 6));
}
- (NSInteger)rowCount
{
    if (_type == ExtTypeChatBar) {
...
@interface EaseExtendMenuView()<UICollectionViewDataSource,SessionToolbarCellDelegate>
{
...
@implementation EaseExtendMenuView
...
- (void)_setupUI {
    ...
    layout.itemSize = CGSizeMake(_menuViewModel.cellLonger, _menuViewModel.cellLonger + 8);
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    EaseExtendMenuModel *extMenuItem = (EaseExtendMenuModel *)_extMenuModelArray[index];
...
@property (nonatomic, strong) EaseExtendMenuModel *menuItemModel;
@end
